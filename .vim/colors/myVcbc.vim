...
let g:colors_name="myVcbc"

hi Normal       cterm=NONE        ctermfg=Black        ctermbg=White        gui=NONE            guifg=NONE         guibg=NONE
" -> Modified in 2021.11.29
hi NonText      cterm=NONE        ctermfg=Black        ctermbg=White        gui=NONE            guifg=NONE         guibg=LightGrey
" <-
...
hi Visual       cterm=NONE        ctermfg=Black        ctermbg=Blue         gui=NONE            guifg=NONE         guibg=Blue
"Diff colors
